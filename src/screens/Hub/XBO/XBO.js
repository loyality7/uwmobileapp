...
const XBO = () => {
  ...
  // Add useEffect and fetch function
  React.useEffect(() => {
    fetchProducts();
  }, []);
    ...
    >
      ...
      <ScrollView style={styles.container}>
        <View style={styles.headingContainer}>
          <Text style={styles.heading}>XBO</Text>
        ...
        <View style={styles.categoriesContainer}>
          {categories.map((category, index) => (
            <TouchableOpacity 
              ...
              onPress={() => navigation.navigate('XBOProducts', { category: category.name })}
            >
        ...
        <View style={styles.sectionMainContainer}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('XBOProducts', { category: 'All' })}>
...
const styles = StyleSheet.create({
  ...
  viewMoreText: {
    color: '#6366f1', // Changed from orange to student color
    fontSize: 14,
    fontWeight: '800',
    fontFamily: 'Gabarito',
    borderRadius: 50,
  ...
  itemDetails: {
    padding: 10,
    backgroundColor: '#edebfe', // Updated color
  },
  itemTitle: {
    fontSize: 18,
    fontWeight: '400',
  ...
  viewButton: {
    backgroundColor: '#6366f1', // Changed from orange to student color
    padding: 8,
    borderRadius: 50,
    alignItems: 'center',
  },
